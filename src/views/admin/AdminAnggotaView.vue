                ...
                <table class="w-full">
                    <thead class="border border-gray-200">
                        <tr>
                            ...
                            <th class="p-2 text-sm font-semibold tracking-wide text-left w-24">Jenis Kelamin
                            </th>
                            <th class="p-2 text-sm font-semibold tracking-wide text-left w-24">Alamat</th>
                            <th class="p-2 text-sm font-semibold tracking-wide text-left w-24">Telepon</th>
                            <th class="p-2 text-sm font-semibold tracking-wide text-left w-24">Korwil</th>
                            <th class="p-2 text-sm font-semibold tracking-wide text-left w-16">action</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
                        <tr v-for="(item, index) in members" :key="index" class="hover:bg-slate-300"
                            ...
                            <td class="p-2 text-sm text-gray-700 whitespace-nowrap">{{ item.gender }}</td>
                            <td class="p-2 text-sm text-gray-700 whitespace-nowrap">{{ item.address }}</td>
                            <td class="p-2 text-sm text-gray-700 whitespace-nowrap">{{ item.telp }}</td>
                            <td class="p-2 text-sm text-gray-700 whitespace-nowrap">{{ item.korwil.region }}
                            </td>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor
                            Telepon</label>
                        <input type="text" id="phone" v-model="form.telp"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
